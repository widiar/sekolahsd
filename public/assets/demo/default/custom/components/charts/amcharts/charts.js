    ...
    var e = function () {
            var e = {
                    1995: [{
                        ...
                        ,
                        {
                            sector: "Mining and Quarrying", size: .6
                        }
                        ,
                        {
                    ...
                    1997: [{
                        ...
                        ,
                        {
                            sector: "Mining and Quarrying", size: .2
                        }
                        ,
                        {
            ...
            AmCharts.makeChart("m_amcharts_13", {
                    ...
                    allLabels: [{
                        y: "54%", align: "center", size: 25, bold: !0, text: "1995", color: "#555"
                    }
                        , {
                            y: "49%", align: "center", size: 15, text: "Year", color: "#555"
                        }
                    ],
                    listeners: [{
    ...
    return {
        init: function () {
            AmCharts.makeChart("m_amcharts_1", {
                    rtl: mUtil.isRTL(), type: "serial", theme: "light", dataProvider: [{
                ...
                AmCharts.makeChart("m_amcharts_2", {
                        ...
                        dataProvider: [{
                            ...
                            , {
                                year: 2013, income: 30.6, expenses: 28.2, dashLengthLine: 5
                            }
                            , {
                                year: 2014,
                                income: 34.1,
                ...
                AmCharts.makeChart("m_amcharts_3", {
                        theme: "light", type: "serial", dataProvider: [{
                            ...
                            unit: "%", position: "left", title: "GDP growth rate"
                        }
                        ...
                        ], plotAreaFillAlphas: .1, categoryField: "country", categoryAxis: {
                            gridPosition: "start"
                        }
                        , export: {
                            enabled: !0
                ...
                AmCharts.makeChart("m_amcharts_4", {
                        theme: "light", type: "serial", dataProvider: [
                            {
                                country: "Januari", year2004: 1023,
                            }
                            , {
                                country: "Februari", year2004: 1201,
                            }
                            , {
                                country: "Maret", year2004: 1000,
                            }
                            , {
                                country: "April", year2004: 1500,
                            }
                            , {
                                country: "Mei", year2004: 1850,
                            }
                            , {
                                country: "Juni", year2004: 2700,
                            }
                            , {
                                country: "Juli", year2004: 3500,
                            }
                            , {
                                country: "Agustus", year2004: 3200,
                            }
                            , {
                                country: "September", year2004: 3600,
                            }
                            , {
                                country: "Oktober", year2004: 3800,
                            }
                            , {
                                country: "Nopember", year2004: 4000,
                            }
                            , {
                                country: "Desember", year2004: 4100,
                            }
                        ], valueAxes: [{
                        ...
                        ], plotAreaFillAlphas: .1, depth3D: 60, angle: 30, categoryField: "country", categoryAxis: {
                            gridPosition: "start"
                        }
                        , export: {
                            enabled: !0
                ...
                AmCharts.makeChart("m_amcharts_5", {
                        ...
                        ], rotate: !0, categoryField: "year", categoryAxis: {
                            gridPosition: "start"
                        }
                        , export: {
                            enabled: !0
                ...
                function () {
                    var e = AmCharts.makeChart("m_amcharts_6", {
                            type: "serial",
                            theme: "light",
                            marginRight: 40,
                            marginLeft: 40,
                            ...
                            graphs: [{
                                id: "g1",
                                balloon: {
                                    drop: !0, adjustBorderColor: !1, color: "#ffffff"
                                }
                                ,
                                bullet: "round",
                                bulletBorderAlpha: 1,
                            ...
                            ,
                            valueScrollbar: {
                                oppositeAxis: !1, offset: 50, scrollbarHeight: 10
                            }
                            ,
                            categoryField: "date",
                            categoryAxis: {
                    ...
                    function a() {
                        e.zoomToIndexes(e.dataProvider.length - 40, e.dataProvider.length - 1)
                    }

                    e.addListener("rendered", a),
                        a()
                }
                (),
                function () {
                    var e = function () {
                        ...
                        (),
                        a = AmCharts.makeChart("m_amcharts_7", {
                                type: "serial",
                                theme: "light",
                                marginRight: 80,
                                autoMarginOffset: 20,
                                ...
                                dataProvider: e,
                                valueAxes: [{
                                    axisAlpha: .2, dashLength: 1, position: "left"
                                }
                                ],
                                mouseWheelZoomEnabled: !0,
                                graphs: [{
                                ...
                                chartScrollbar: {
                                    autoGridCount: !0, graph: "g1", scrollbarHeight: 40
                                }
                                ,
                                chartCursor: {
                                    limitToGraph: "g1"
                                ...
                                categoryField: "date",
                                categoryAxis: {
                                    parseDates: !0, axisColor: "#DADADA", dashLength: 1, minorGridEnabled: !0
                                }
                                ,
                                export: {
                                    enabled: !0
                    ...
                    a.addListener("rendered", t),
                        t()
                }
                (),
                AmCharts.makeChart("m_amcharts_8", {
                        type: "serial", theme: "light", legend: {
                            equalWidths: !1, useGraphSettings: !0, valueAlign: "left", valueWidth: 120
                        }
                        , dataProvider: [{
                            date: "2012-01-01",
                            distance: 227,
                            ...
                            , {
                                id: "durationAxis", duration: "mm", durationUnits: {
                                    hh: "h ", mm: "min"
                                }
                                , axisAlpha: 0, gridAlpha: 0, inside: !0, position: "right", title: "duration"
                            }
                        ], graphs: [{
                            alphaField: "alpha",
                ...
                AmCharts.makeChart("m_amcharts_9", {
                        type: "radar", theme: "light", dataProvider: [{
                ...
                AmCharts.makeChart("m_amcharts_10", {
                        ...
                        ], categoryField: "direction", export: {
                            enabled: !0
                        }
                    }
                ),
                AmCharts.makeChart("m_amcharts_11", {
                        type: "radar", theme: "light", dataProvider: [], valueAxes: [{
                            gridType: "circles", minimum: 0
                        }
                        ], startDuration: 1, polarScatter: {
                            minimum: 0, maximum: 359, step: 1
                        }
                        , legend: {
                            position: "right"
                        }
                ...
                AmCharts.makeChart("m_amcharts_12", {
                        ...
                        ], valueField: "litres", titleField: "country", balloon: {
                            fixedPosition: !0
                        }
                        , export: {
                            enabled: !0
