...
var BootstrapTimepicker = function () {
    ...
    var demos = function () {
        // minimum setup
        $('#m_timepicker_1, #m_timepicker_1_modal, .m_timepicker_1_modal').timepicker();
        ...
        // minimum setup
        $('#m_timepicker_1_validate, #m_timepicker_2_validate, #m_timepicker_3_validate, .timepicker').timepicker({
            minuteStep: 1,
            showSeconds: true,
            showMeridian: false,
            snapToStep: true
