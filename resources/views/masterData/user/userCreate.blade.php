                ...
                <div class="modal-body">
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group">
                            ...
                            <select name="id_user_role" class="form-control m-select2 role-select" style="width: 100%">
                        ...
                        <div class="form-group m-form__group guru-select" style="display: none">
                            ...
                            <select name="id_guru" class="form-control m-select2" style="width: 100%">
                                <option value="">Pilih</option>
                                @foreach($guru as $r)
                                    <option value="{{ $r->id_guru }}">{{ $r->gru_nip }} - {{ $r->gru_nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group m-form__group siswa-select" style="display: none">
                            <label class="form-control-label required">Siswa</label>
                            <select name="id_siswa" class="form-control m-select2" style="width: 100%">
                                <option value="">Pilih</option>
                                @foreach($siswa as $r)
                                    <option value="{{ $r->id_siswa }}">{{ $r->swa_nis }} - {{ $r->swa_nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group m-form__group">
