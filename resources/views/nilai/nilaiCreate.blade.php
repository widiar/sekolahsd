                ...
                <div class="modal-body">
                    <div class="m-portlet__body">
                        {{-- <div class="form-group m-form__group">
                            ...
                            <select class="form-control m-select2" name="id_absen" data-placeholder="Pilih Guru"
                                style="width: 100%">
                                @foreach($siswa as $row)
                                <option value="{{ $row->id_siswa }}">{{ $row->swa_nis }}&nbsp&nbsp&nbsp{{ $row->swa_nama
                                    }}</option>
                                @endforeach
                            </select>
                        </div> --}}
                        <div class="form-group m-form__group">
                            ...
                            <select class="form-control m-select2" name="id_siswa" data-placeholder="Pilih Siswa"
                                style="width: 100%">
                                @foreach($siswa as $row)
                                @if($row->kelas->id_guru == $user->id_karyawan)
                                <option value="{{ $row->id_siswa }}">{{ $row->swa_nis }} - {{ $row->swa_nama }}</option>
                                @endif
                                @endforeach
                            </select>
                        </div>
                        ...
                        {{-- <div class="form-group m-form__group">
                            ...
                            <select class="form-control m-select2" name="id_kelas" data-placeholder="Pilih Siswa"
                                style="width: 100%">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <select class="form-control m-select2" name="id_mata_pelajaran"
                                ...
                                <option value="{{ $row->id_mata_pelajaran }}">{{ $row->mpj_kode }} - {{ $row->mpj_nama
                                    }}</option>
                                @endforeach
                            </select>
                        </div>
