<form action="{{ route('siswaUpdate', ['id'=>Main::encrypt($edit->id_siswa)]) }}" method="post"
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group">
                           ...
                           <select class="form-control m-select2" name="id_kelas"
                                   ...
                                   <option value="{{$row->id_kelas}}" @if($row->id_kelas == $edit->id_kelas) selected @endif>{{ $row->kls_nama . $row->sub_kelas }}</option>
                                   @endforeach
                           </select>
                        </div>
                        <div class="form-group m-form__group">
