                ...
                <div class="modal-body">
                    <div class="m-portlet__body">
                        ...
                        {{-- <div class="form-group m-form__group">
                            ...
                            <select class="form-control m-select2" name="id_siswa" data-placeholder="Pilih Siswa"
                                style="width: 100%">
                                @foreach($siswa as $row)
                                <option value="{{ $row->id_siswa}}" {{ $row->id_siswa == $edit->id_siswa ? 'selected' :
                                    '' }}>
                                    {{ $row->swa_nis }}&nbsp&nbsp&nbsp{{ $row->swa_nama }}&nbsp&nbsp&nbsp{{
                                    $row->kelas->kls_nama }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input type="text" class="form-control m-input" name="id_siswa" disabled
                                value="{{ $edit->siswa->swa_nama}}">
                        </div>
                        {{-- <div class="form-group m-form__group">
                            <label class="form-control-label required">Kelas</label>
                            <select class="form-control m-select2" name="id_kelas" data-placeholder="Pilih Kelas"
                                style="width: 100%">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <select class="form-control m-select2" name="abs_keterangan" style="width: 100%">
                                <option value="hadir" @if($edit->abs_keterangan == 'hadir') selected @endif>Hadir</option>
                                <option value="izin" @if($edit->abs_keterangan == 'izin') selected @endif>Izin</option>
                                <option value="sakit" @if($edit->abs_keterangan == 'sakit') selected @endif>Sakit</option>
                                <option value="alpha" @if($edit->abs_keterangan == 'alpha') selected @endif>Alpha</option>
                            </select>
                        </div>
                    </div>
                </div>
