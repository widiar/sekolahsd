                ...
                <div class="modal-body">
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <select class="form-control m-select2" name="id_siswa" data-placeholder="Pilih Guru"
                                style="width: 100%">
                        ...
                        {{-- <input hidden type="text" class="form-control m-input" name="id_kelas" value="6"> --}}
                        {{-- <div class="form-group m-form__group">
                            <label class="form-control-label required">Kelas</label>
                            <select class="form-control m-select2" name="id_kelas" data-placeholder="Pilih Guru"
                                style="width: 100%">
