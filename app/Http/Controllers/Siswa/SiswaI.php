...
class SiswaI extends Controller
{
    private $breadcrumb;
    ...
    function index(Request $request)
    {
        ...
        return view('siswa/I/siswaList', $data);
    }
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right"
                        ...
                        <a class="akses-action_wait_cancel dropdown-item btn-modal-general"
                           href="#"
                            data-route="' . route('siswaEditModalI', ['id_siswa' => $id_siswa]) . '">
