...
class SiswaVI extends Controller
{
    private $breadcrumb;
    ...
    function index(Request $request)
    {
        ...
        return view('siswa.VI.siswaList', $data);
    }
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right"
                        ...
                        <a class="akses-action_wait_cancel dropdown-item btn-modal-general"
                           href="#"
                            data-route="' . route('siswaEditModalVI', ['id_siswa' => $id_siswa]) . '">
    ...
    function edit_modal($id_siswa)
    {
        ...
        return view('siswa/VI/siswaEditModal', $data);
    }
