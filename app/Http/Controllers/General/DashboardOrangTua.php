...
class DashboardOrangTua extends Controller
{
    private $breadcrumb = [
        [
            'label' => 'dashboard_orang_tua',
            'route' => ''
        ]
    ];
    ...
    {
//        return Session::all();
        $data = $this->data_dashboard_orang_tua($request);

//        return $data['cart_patient'];

        return view('dashboard/dashboard_orang_tua', $data);

    }


    function data_dashboard_orang_tua($request)
    {
