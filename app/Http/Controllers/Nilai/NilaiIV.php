...
class NilaiIV extends Controller
{
    private $breadcrumb;
    ...
    function index(Request $request)
    {
        ...
        $siswa = mSiswa::orderBy('swa_nama', 'ASC')->where('id_kelas',4)->get();
        $kelas = mKelas::orderBy('kls_nama', 'ASC')->get();
        $mata_pelajaran = mMataPelajaran::orderBy('mpj_nama', 'ASC')->where('mpj_kelas','II')->get();
        $datatable_column = [
            ["data" => "no"],
            ["data" => "swa_nis"],
            ["data" => "swa_nama"],
        ...
        return view('nilai.IV.nilaiList', $data);
    }
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right"
                        ...
                        <a class="akses-action_wait_cancel dropdown-item btn-modal-general"
                           href="#"
                            data-route="' . route('nilaiEditModalIV', ['id_nilai' => $id_nilai]) . '">
    ...
    function edit_modal($id_nilai)
    {
        ...
        $siswa = mSiswa::orderBy('swa_nama', 'ASC')->where('id_kelas',4)->get();
        $kelas = mKelas::orderBy('kls_nama', 'ASC')->get();
        $mata_pelajaran = mMataPelajaran::orderBy('mpj_nama', 'ASC')->where('mpj_kelas','IV')->get();
        $data = [
            'edit' => $edit,
            'absen' => $absen,
            'siswa' => $siswa,
        ...
        return view('nilai.IV.nilaiEditModal', $data);
    }
