...
class NilaiIII extends Controller
{
    private $breadcrumb;
    ...
    function index(Request $request)
    {
        ...
        $mata_pelajaran = mMataPelajaran::orderBy('mpj_nama', 'ASC')->where('mpj_kelas','III')->get();
        $datatable_column = [
            ["data" => "no"],
            ["data" => "swa_nis"],
            ["data" => "swa_nama"],
        ...
        return view('nilai.III.nilaiList', $data);
    }
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right"
                        ...
                        <a class="akses-action_wait_cancel dropdown-item btn-modal-general"
                           href="#"
                            data-route="' . route('nilaiEditModalIII', ['id_nilai' => $id_nilai]) . '">
    ...
    function edit_modal($id_nilai)
    {
        ...
        return view('nilai.III.nilaiEditModal', $data);
    }
