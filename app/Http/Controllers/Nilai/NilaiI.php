...
class NilaiI extends Controller
{
    private $breadcrumb;
    ...
    function index(Request $request)
    {
        ...
        $siswa = mSiswa::orderBy('swa_nama', 'ASC')->where('id_kelas',1)->get();
        $kelas = mKelas::orderBy('kls_nama', 'ASC')->get();
        $mata_pelajaran = mMataPelajaran::orderBy('mpj_nama', 'ASC')->where('mpj_kelas','I')->get();
        $datatable_column = [
            ["data" => "no"],
            ["data" => "swa_nis"],
            ["data" => "swa_nama"],
        ...
        return view('nilai.I.nilaiList', $data);
    }
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right"
                        ...
                        <a class="akses-action_wait_cancel dropdown-item btn-modal-general"
                           href="#"
                            data-route="' . route('nilaiEditModalI', ['id_nilai' => $id_nilai]) . '">
    ...
    function edit_modal($id_nilai)
    {
        ...
        return view('nilai.I.nilaiEditModal', $data);
    }
