...
class NilaiII extends Controller
{
    private $breadcrumb;
    ...
    function index(Request $request)
    {
        ...
        $siswa = mSiswa::orderBy('swa_nama', 'ASC')->where('id_kelas',2)->get();
        ...
        return view('nilai.II.nilaiList', $data);
    }
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right"
                        ...
                        <a class="akses-action_wait_cancel dropdown-item btn-modal-general"
                           href="#"
                            data-route="' . route('nilaiEditModalII', ['id_nilai' => $id_nilai]) . '">
    ...
    function edit_modal($id_nilai)
    {
        ...
        return view('nilai.II.nilaiEditModal', $data);
    }
