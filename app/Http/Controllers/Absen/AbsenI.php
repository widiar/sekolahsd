...
class AbsenI extends Controller
{
    private $breadcrumb;
    ...
    function index(Request $request)
    {
        ...
        // dd($data['menu']);
        return view('absen.I.absenList', $data);
    }
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right"
                        ...
                        <a class="akses-action_wait_cancel dropdown-item btn-modal-general"
                           href="#"
                            data-route="' . route('absenEditModalI', ['id_absen' => $id_absen]) . '">
    ...
    function edit_modal($id_absen)
    {
        ...
        return view('absen/I/absenEditModal', $data);
    }
