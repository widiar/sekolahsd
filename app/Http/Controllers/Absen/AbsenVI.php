...
class AbsenVI extends Controller
{
    private $breadcrumb;
    ...
    function index(Request $request)
    {
        ...
        return view('absen.VI.absenList', $data);
    }
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right"
                        ...
                        <a class="akses-action_wait_cancel dropdown-item btn-modal-general"
                           href="#"
                            data-route="' . route('absenEditModalVI', ['id_absen' => $id_absen]) . '">
    ...
    function edit_modal($id_absen)
    {
        ...
        return view('absen/VI/absenEditModal', $data);
    }
